"""SQL Generation Agent - Main Agent Implementation."""
...
class SqlGenerationAgentAgent:
    ...
    def __init__(self):
        ...
        self.nl_to_sql_enabled = True
        self.query_optimization_enabled = True
        self.schema_validation_enabled = True
        self.dialect_support_enabled = True
        self.query_explanation_enabled = True
        self._tool_dispatch = {
            "generate_sql": self.tools.generate_sql,
            "validate_query": self.tools.validate_query,
            "explain_query": self.tools.explain_query,
            "optimize_query": self.tools.optimize_query,
            "translate_dialect": self.tools.translate_dialect,
        }
        logger.info(
            "agent_initialized",
            ...
            features=['nl_to_sql', 'query_optimization', 'schema_validation', 'dialect_support', 'query_explanation'],
        )
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            ...
            "translate_dialect": ['translate', 'dialect'],
        }
